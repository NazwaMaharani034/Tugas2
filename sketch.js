...
let colors = ['violet','blue', 'red', 'magenta','green'];
...
let urlApi = 'https://api.openweathermap.org/data/2.5/weather?q=Jakarta&appid=907661592141197239ee010d8e962905&units=metric'
let dataSheet;
let xData;
let yData;
let dataApi;
